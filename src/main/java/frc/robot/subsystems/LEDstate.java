...
/* nie jestem pewna czy z tym bedzie dzialac czy nie XD
...
public class LEDstate extends SubsystemBase {
  ...
  public enum StateLedFlag {
    Target_VISABLE, //widoczny target na limelight
    SHOOTER_STARTING,//rozpedza sie shooter
    SHOOTING,
    SHOOTING_END,//koniec strzelania
    INTAKE_UP,//intake jest złożony
    INTAKE_DOWN,//intake jest rozłożony
    TRANSPORTER_FULL,//pełny transporter
    TRANSPORTER_HALF_FULL,//w połowie pełny transporter
    POLZEI_MODE,//w sumie to nie wiemXD
    TEST_MODE,
    AIMED,//celowanie
    AIMED_AUTO,//autoamtyczne celowanie
    SET_AIMING_POSITION,//ustaw pozycje do celowania
    STANDARD,
    TELEOP_INT,
    AUTO_INT,
    RAINBOW,
  ...
  private void setColor(Color kdeepskyblueColor) {}

  public LEDstate() {
    
     /* tutaj tak samo jak będzie działać bez tego to zajebiscie
  ...
  public void periodic() {
    switch(LedFlag) {
      case Target_VISABLE:
        ...
        break;
      case SHOOTER_STARTING:
        setColor(Color.kLavender);
        break;
      case SHOOTING:
      ...
      case INTAKE_DOWN:
        ...
        break;
      case TRANSPORTER_FULL:
        setColor(Color.kRed);
        break;
      case TRANSPORTER_HALF_FULL:
        setColor(Color.kIndianRed);
        break;
      case AIMED:
  ...
  public void checkSystems(){
    checkDriveTrain();//zalezy jak chlopaki to nazwali XD
    checkShooter();//zalezy jak chlopaki to nazwali XD
    checkSensors();//zalezy jak chlopaki to nazwali XD
  }
